...
from boopy.time.calendars.utils import is_weekend, calc_day_of_year
...
if __name__ == "__main__":
    ...
    assert (
        sweden_is_business_day(datetime.date(2023, 5, 18)) == False
    )  # Ascension Thursday
    ...
    assert (
        sweden_is_business_day(datetime.date(2023, 12, 31)) == False
    )  # New Year's Eve
